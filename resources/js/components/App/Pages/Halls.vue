            ...
            <div class="col-sm-6" v-for="hall in children">
              <card card-body-classes="text-center">
                        <span style="position: absolute; top:0px; right:6px;">
                            <a href="#" @click.prevent="openDeleteDialog(hall.uid)"><i class="fa fa-times fa-lg text-danger"></i></a>
                        </span>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <p-button type="default" size="sm" outline round @click="openEditor(hall.uid)" class="w-100">
...
<script>
  ...
  export default {
    ...
    methods: {
      saveRootEntity() {
        let data = {id:this.rootEntity.id, name:this.rootEntity.name, address:this.rootEntity.address, about:this.rootEntity.about}
