...
window.Vue.component(_chenfengyuan_vue_carousel__WEBPACK_IMPORTED_MODULE_0___default.a.name, _chenfengyuan_vue_carousel__WEBPACK_IMPORTED_MODULE_0___default.a);
var app = new Vue({
  el: '#welcome',
  data: {
    // data for carousel
    carousel: ['<div class="carousel-slide">Always borrow money from a pessimist. He won’t expect it back.</div>', '<div class="carousel-slide">It is awfully hard work doing nothing.</div>', '<div class="carousel-slide">Be yourself, everyone else is already taken.</div>', '<div class="carousel-slide">Hey, want some more?</div>']
  }
});
...
module.exports = __webpack_require__(/*! /Users/dmytro/leisurespace/JerkApi/resources/js/welcome.js */"./resources/js/welcome.js");
